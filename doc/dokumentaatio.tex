...
\textbf{Asiakas} on käyttäjä, joka voi tehdä tarjouksia huutokaupassa myynnissä olevista tuotteista.
...
Asiakkaat voivat tehdä huutokaupassa myytävänä olevista tuotteista ostotarjouksia tiettyyn hintaan.
...
\begin{tabular}{ | c | c | c |}
 ...
 Määrä & Desimaaliluku & Tarjouksen määrä \\ \hline
 Yhteystiedot & Merkkijono, max. 200 merkkiä & Tarjoajan yhteystiedot \\ \hline
 Kokonimi & Merkkijono, max. 30 merkkiä & Tarjoajan koko nimi \\ \hline
 Osoite & Merkkijono, max. 100 merkkiä & Tarjoajan katuosoite \\ \hline
 Postinumero & Kokonaisluku & Tarjoajan postinumero \\ \hline
 Kaupunki & Merkkijono, max. 30 merkkiä & Tarjoajan asuinkaupunki \\ \hline
 Sotu & Merkkiono, max. 20 merkkiä & Tarjoajan sosiaaliturvatunnus \\
 \hline
\end{tabular}
...
Käyttäjä voi liittyä useaan mutta ei välttämättä liity yhteenkään tuotteeseen.
...
Asenna sovellus kopioimalla sen tiedot palvelimen nettiin näkyvään hakemistoon. Aseta sen jälkeen tietokannan tiedot oikeiksi tiedostoon lib/database.php.
...
Sovelluksen etusivulla listataan huutokaupassa myytävänä olevat tuotteet. Kirjautumaton käyttäjä voi tehdä tarjouksia myytävänä olevista tuotteista, katsella tuotteiden tietoja sekä selata tuoteluokituksia. Kirjautunut käyttäjä voi lisäksi lisätä huutokauppaan uuden tuotteen, muokata myytävänä olevan tuotteen tietoja, poistaa myytävänä olevan tuotteen sekä lisätä, muokata ja poistaa tuoteluokituksia.
...
\begin{tabular}{ | c | c | c |}
 ...
 To 5.4.2016 & 1h & Korjauksia ja dokumentaation päivitystä \\ \hline
 \textbf{Yhteensä} & \textbf{38,5h} & \\
 \hline
\end{tabular}
